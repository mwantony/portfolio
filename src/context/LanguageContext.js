...
const translations = {
  pt: {
    ...
    home: {
      ...
      bioP2_1: "Tenho experiência com ReactJS, PHP, Laravel e desenvolvimento de interfaces, além de ter criado soluções próprias, como o sistema de gestão e comandas para restaurantes da ",
      bioP2_tyra: "Tyra",
      bioP2_2: ".",
  ...
  en: {
    ...
    home: {
      ...
      bioP2_1: "I have experience with ReactJS, PHP, Laravel, and user interface development, in addition to having created my own solutions, such as Tyra's restaurant management and order system at ",
      bioP2_tyra: "Tyra",
      bioP2_2: ".",
